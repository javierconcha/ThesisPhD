...
The validation of the retrieval is performed through comparison with both {\it in situ} data and standard bio-optical products. This comparison is done for the results from the atmospheric correction and from the retrieval process.
% -------------------------------------------------------------
