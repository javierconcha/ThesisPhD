...
Then, the following step is to correct the glint in the image, if present. Details of one the glint methods are described in \S\ref{subsec:glintremoval} below.
