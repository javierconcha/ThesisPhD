...
\begin{figure}[htb]
  \centering
    \includegraphics[height=8cm]{C:/Users/Aixa/Dropbox/Javier/ConferencesAndApplications/2015_Landsat_Special_Issue/Images/Retrieval_RMSE.pdf}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=11cm,clip=true]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/RegressionHedley.png}
...
\begin{figure}[htb]
  \begin{minipage}[c]{0.48\linewidth}
    \centering
      \includegraphics[trim=30 0 30 0,clip,height=6cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/DTROCL8falsecolor.jpg}  
    % \vspace{1.5cm}
  ...
  \begin{minipage}[d]{0.48\linewidth}
    \centering
      \includegraphics[trim=30 0 30 0,clip,height=6cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/PIFmaskApplied.jpg}
    % \vspace{1.5cm}
...
\begin{figure}[!ht]
  \begin{minipage}[c]{0.48\linewidth}
    \centering
      \includegraphics[height=9cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/PIFstatCDR.png}  
    % \vspace{1.5cm}
    \centerline{(a)}\medskip
  \end{minipage}
  \hfill
  \begin{minipage}[d]{0.48\linewidth}
    \centering
      \includegraphics[height=9cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/PIFstatL8.png}
    % \vspace{1.5cm} 
    \centerline{(b)}\medskip
  \end{minipage}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[height=13cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/Shadow.png}
...
\begin{figure}[htb]
  	\centering
  	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/ZenithCorrelation.eps}
  \caption{Correlation for band 1. \label{fig:Band1Corr} } 
\end{figure}

\begin{figure}[htb]
  	\centering
  	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/ZenithCorrection.eps}
...
\begin{figure}[htb]
  	\centering
  	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/Extrapolation.eps}
...
\begin{figure}[htb]
  	\centering
  	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/CHLaastJavier.eps}
...
\begin{figure}[htb]
  	\centering
  	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/CHLbastRolo.eps}
...
\begin{figure}[!ht]
  	\centering
  	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/ONTNS_CDOMabs.eps}
...
\begin{figure}[!ht]
  	\centering
  	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/ONTNS_CDOMfitting.eps}
...
\begin{figure}[!ht]
  	\centering
  	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/SMaastJavier.eps}
...
\begin{figure}[!ht]
  	\centering
  	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/SMbastRolo.eps}
...
\begin{figure}[htb]
  	\centering
  	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/RefWithFFbbONTNS.eps}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=14cm,clip=true]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/ELMpixelsENVI.pdf}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=11cm,clip=true]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/epsilonvslambdaGordon.png}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=10cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/RuddickPlot.png}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=14cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/4DLUT.png}
...
\begin{figure}[htb]
    \centering
      \includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/ConferencesAndApplications/2014_ASPRS_SOY/Images/LUT.eps}
...
% \begin{figure}[htb]
%   	\centering
%   	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/CHLaastLONGSJavier.eps}
...
% \begin{figure}[htb]
%   	\centering
%   	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/astar_CDOM_LONGS091913.eps}
%   \caption{CDOM mass-specific absorption spectra used to create the LUT in HydroLight. \label{fig:CDOMaastLONGS} } 
% \end{figure}

% \begin{figure}[htb]
%   	\centering
%   	\includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/astar_SM_LONGS091913.eps}
...
\begin{figure}[htb]
  \centering
  \includegraphics[height=9cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/AreaOfStudy1.pdf}
  \caption{Area of Study. \label{fig:areaofstudy1} } 
\end{figure}
\begin{figure}[htb]
  \centering
  \includegraphics[height=7cm]{C:/Users/Aixa/Dropbox/Javier/Latex/Proposal/Images/AreaOfStudy2.pdf}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[height=8.0cm]{C:/Users/Aixa/Dropbox/Javier/ConferencesAndApplications/2015_SPIE_SanDiego/Images/ROI_RocEmbayment130919-eps-converted-to.pdf}
...
Additionally, the results for the \gls{mobelm} and the CPA retrieval are compared with the products derived in the l2gen algorithm the in \gls{seadas} software.\todo{complete more!}
