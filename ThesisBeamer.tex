...
\Large
{\bf Objective:}\\
To develop over-water atmospheric correction \cite{Raqueno:2000,Gerace:2012}.\\
\vspace{0.5cm}
\large
Work published in:
\small
...
\begin{figure}[htbp!]
  ...
  \begin{minipage}[d]{0.49\linewidth}
  	\centering
      \begin{overpic}[trim=0 0 0 340,clip,width=4.3cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_655_Acolite-SWIR_SeaDAS-MUMM.png}
      \end{overpic}
  \end{minipage}    
...
\begin{itemize}\itemsep0.5cm
	...
	\item MoB-ELM performed similar to \cite{Gordon:1994} approach overall (SeaDAS-SWIR)
\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\Large
{\bf Objective:}\\
To develop a Color Producing Agent (CPA) retrieval \cite{Raqueno:2000,Gerace:2012}.\\
\vspace{0.5cm}
\large
Work published in:
\small
...
\begin{figure}[htbp!]
  \begin{minipage}[a]{0.485\linewidth}
  	\hspace{-0.5cm}
      \centering
      \includegraphics[trim=0 0 0 120,clip,width=5.0cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/CHLmap140929masked.png}  
  \end{minipage}
\hfill
%% TSS
  \begin{minipage}[a]{0.485\linewidth}
      \centering
      \includegraphics[trim=0 0 0 120,clip,width=5.0cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/TSSmap140929masked.png}  
  \end{minipage}\\
%% CDOM
      \vspace{0.3cm}
  \begin{minipage}[c]{0.485\linewidth}
  \hspace{-0.5cm}
      \centering
      \includegraphics[trim=0 0 0 120,clip,width=5.0cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/CDOmap140929masked.png}  
  \end{minipage}
  \hfill
  \begin{minipage}[c]{0.485\linewidth}
  	\vspace{-0.7cm}
      \centering
      \includegraphics[trim=0 0 0 120,clip,width=5.0cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/ROIRGB140929masked.png}  
  \end{minipage}
%
  % \caption{CPA retrieval results for the Landsat 8 image acquired on 09-19-2013 (scene LC80160302013262LGN00). Concentration maps (left) and measured vs retrieved plots (right). The dashed line represent the 1:1 line. (Labels: LongS: Long Pond south, Cranb: Cranberry Pond, OntOS: Lake Ontario off-shore, and OntNS: Lake Ontario near-shore). \label{fig:CPAsMaps130919} } 
\end{figure}
...
\begin{figure}[htbp!]
  \begin{minipage}[a]{0.485\linewidth}
  	\hspace{-0.5cm}
      \centering
      \includegraphics[trim=0 0 0 120,clip,width=5.0cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/CHLmap150916masked.png}  
  \end{minipage}
\hfill
%% TSS
  \begin{minipage}[a]{0.485\linewidth}
      \centering
      \includegraphics[trim=0 0 0 120,clip,width=5.0cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/TSSmap150916masked.png}  
  \end{minipage}\\
%% CDOM
      \vspace{0.3cm}
  \begin{minipage}[c]{0.485\linewidth}
  \hspace{-0.5cm}
      \centering
      \includegraphics[trim=0 0 0 120,clip,width=5.0cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/CDOmap150916masked.png}  
  \end{minipage}
  \hfill
  \begin{minipage}[c]{0.485\linewidth}
  	\vspace{-0.7cm}
      \centering
      \includegraphics[trim=0 0 0 120,clip,width=5.0cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/ROIRGB150916masked.png}  
  \end{minipage}
%
  % \caption{CPA retrieval results for the Landsat 8 image acquired on 09-19-2013 (scene LC80160302013262LGN00). Concentration maps (left) and measured vs retrieved plots (right). The dashed line represent the 1:1 line. (Labels: LongS: Long Pond south, Cranb: Cranberry Pond, OntOS: Lake Ontario off-shore, and OntNS: Lake Ontario near-shore). \label{fig:CPAsMaps130919} } 
\end{figure}
...
\begin{itemize}\itemsep0.5cm
	...
	\item A mixed method: to combine MoB-ELM for coastal and \cite{Gordon:1994} 
	for open waters
	\item To take in account adjacency effect
\end{itemize}
\end{frame}
% ----------------------------------- Slide -------------------------------------
...
\begin{itemize}\itemsep0.5cm
	...
	\item Better validation of the Hydrolight outputs: IOP-AOP inversion models
\end{itemize}
...
\begin{itemize}\itemsep0.5cm
	...
	\item Algorithms integration
	% \item To study IOP stability over time
	\item Better estimation of the scattering properties: IOP-AOP inversion models
\end{itemize}
\end{frame}
% ----------------------------------- Slide -------------------------------------
...
\Large
\begin{itemize}\itemsep0.5cm
	\item My colleagues and friends
	\item All my families here: SPIE Chapter, Tiger Tales Toastmasters, RIT Fulbright Scholars Association, Chile Lindo, LRDC 
	\item My girlfriend Yana
