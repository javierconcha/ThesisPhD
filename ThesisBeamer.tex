...
\setbeamertemplate{section in head/foot}{\hfill\protect\tikz[baseline=(P.base)] \protect\node[trapezium,fill=RITorange,rounded corners=2pt,inner sep=2.5pt](P){\textcolor{black}{\bfseries\insertsectionhead}};}

\setbeamertemplate{section in head/foot shaded}{\hfill\protect\tikz[baseline=(P.base)] \protect\node[trapezium,draw=RITorange,fill=white,rounded corners=2pt,inner sep=2.5pt](P){\textcolor{fg!70!bg}{\insertsectionhead}};}
...
\end{frame}
% ----------------------------------- Slide ------------------------------------
\begin{frame}[t]\frametitle{\LARGE Flowchart}
...
\node[inner sep=0pt,above of=L8image]
    {\includegraphics[width=.3\textwidth]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/LC80170302014272LGN00_AreaOfStudy.png}};\pause
% step 2
...
\node[inner sep=0pt,above of=CPAmap]
    {\includegraphics[trim=0 0 0 30,clip,width=.25\textwidth]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_Landsat_Special_Issue/Images/TSSmap140929_150420}};
