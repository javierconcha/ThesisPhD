...
Lab Measurements:
\begin{itemize}
	\item Chlorophyll-{\it a} concentration, Total Suspended Solids (TSS)
	\item Chlorophyll-{\it a}, Particles and CDOM absorption coefficients
\end{itemize}
\vspace{0.5cm}
* Lab measurements were validated with the Monroe County Environmental Lab measurements
\end{frame}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Field Data Collection (con't)}
\vspace{-1cm}
...
\end{frame}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Measured $R_{rs}$ and $a$}
Figures from the field and lab
\end{frame}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Field Data Collection (con't)}{\vspace{0.1cm} \Large 2013, 2014 and 2015 Seasons}
\begin{table}[htb]
...
\begin{figure}[htbp!]
  ...
  \begin{minipage}[d]{0.49\linewidth}
  	\centering
      \begin{overpic}[trim=0 60 0 0,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_443_Acolite-SWIR_MoB-ELM.png}
  ...
  % \begin{minipage}[c]{0.49\linewidth}
  % 		\centering
  %     \begin{overpic}[trim=0 60 0 0,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_443_Acolite-SWIR_SeaDAS-SWIR.png}
  %     % \put (65,17) {\large C) $561nm$}
  %     \end{overpic}  
  % \end{minipage}
  \begin{minipage}[d]{0.49\linewidth}
  	\centering
      \begin{overpic}[trim=0 60 0 0,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_443_SeaDAS-MUMM_MoB-ELM.png}
  ...
  % \begin{minipage}[c]{0.49\linewidth}
  % 		\centering
  %     \begin{overpic}[trim=0 60 0 0,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_443_SeaDAS-SWIR_SeaDAS-MUMM.png}
  %     % \put (65,17) {\large C) $561nm$}
  %     \end{overpic}  
  % \end{minipage}
  % \hfill
  \begin{minipage}[d]{0.49\linewidth}
  	\centering
      \begin{overpic}[trim=0 60 0 0,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_443_SeaDAS-SWIR_MoB-ELM.png}
      % \put (65,17) {\large D) $655nm$}
      \end{overpic}
  \end{minipage}
  \hfill
  \begin{minipage}[d]{0.49\linewidth}
  	\centering
      \begin{overpic}[trim=0 0 0 340,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_655_Acolite-SWIR_SeaDAS-MUMM.png}
      \end{overpic}
  \end{minipage}    
...
\begin{figure}[htbp!]
  ...
  \begin{minipage}[d]{0.49\linewidth}
  	\centering
      \begin{overpic}[trim=0 60 0 0,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_561_Acolite-SWIR_MoB-ELM.png}
      % \put (65,17) {\large B) $483nm$}
      \end{overpic}
  \end{minipage}
  \hfill
  % \begin{minipage}[c]{0.49\linewidth}
  % 		\centering
  %     \begin{overpic}[trim=0 60 0 0,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_561_Acolite-SWIR_SeaDAS-SWIR.png}
  %     % \put (65,17) {\large C) $561nm$}
  %     \end{overpic}  
  % \end{minipage}
  \begin{minipage}[d]{0.49\linewidth}
  	\centering
      \begin{overpic}[trim=0 60 0 0,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_561_SeaDAS-MUMM_MoB-ELM.png}
      % \put (65,17) {\large D) $655nm$}
      \end{overpic}
  \end{minipage}\\
  \vspace{0.3cm}
  ...
  % \begin{minipage}[c]{0.49\linewidth}
  % 		\centering
  %     \begin{overpic}[trim=0 60 0 0,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_561_SeaDAS-SWIR_SeaDAS-MUMM.png}
  %     % \put (65,17) {\large C) $561nm$}
  %     \end{overpic}  
  % \end{minipage}
  % \hfill
  ...
  \begin{minipage}[d]{0.49\linewidth}
  	\centering
      \begin{overpic}[trim=0 60 0 0,clip,width=4cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/2013262_ACOMOBSEAMUM_561_SeaDAS-SWIR_MoB-ELM.png}
      % \put (65,17) {\large D) $655nm$}
      \end{overpic}
  \end{minipage}
  \hfill
...
\end{frame}
% ----------------------------------- Slide -------------------------------------
\begin{frame}{\LARGE Atmospheric Correction}{\vspace{0.1cm} \Large Conclusions}
...
\begin{figure}[htbp!]
  \begin{minipage}[a]{0.485\linewidth}
  	\hspace{-0.5cm}
      % \centering
      \includegraphics[trim=0 0 0 0,clip,height=3.6cm,grid=on]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/CHLmap130919masked.png}  
  \end{minipage}
\hfill
%% TSS
  \begin{minipage}[a]{0.485\linewidth}
      % \centering
      \vspace{-0.1cm}
      \includegraphics[trim=0 0 0 0,clip,height=3.5cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/TSSmap130919masked.png}  
  \end{minipage}
%% CDOM
  \begin{minipage}[c]{1.0\linewidth}
  	\vspace{0.05cm}
      \centering
      \includegraphics[trim=0 0 0 0,clip,height=3.7cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/CDOmap130919masked.png}  
  \end{minipage}
%
...
\begin{figure}[htbp!]
  ...
  \hspace{-0.5cm}
      \centering
      \includegraphics[trim=0 0 0 50,clip,height=3.7cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/CHLmap140929masked.png}  
  \end{minipage}
\hfill
%% TSS
  \begin{minipage}[c]{0.49\linewidth}
  \vspace{-0.1cm}
      \centering
      \includegraphics[trim=0 0 0 50,clip,height=3.6cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/TSSmap140929masked.png}  
  \end{minipage}
...
%% CDOM
  \begin{minipage}[c]{1.0\linewidth}
  		\vspace{0.05cm}
      \centering
      \includegraphics[trim=0 0 0 50,clip,height=3.7cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/CDOmap140929masked.png}  
  \end{minipage}
...
\begin{figure}[htb!]
  \begin{minipage}[c]{0.48\linewidth}
    \centering
      \includegraphics[width=5cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPHD/Images/ChlStandardFixed.png}\\
      \centerline{Variable chlorophyll Fixed CDOM and sediments}\medskip
  \end{minipage}
  \hfill      
  \begin{minipage}[c]{0.48\linewidth}
    \centering
      \includegraphics[width=5cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPHD/Images/ChlStandardNoFixed.png}\\
      \centerline{Variable CDOM, sediments and chlorophyll}\medskip
  \end{minipage}
