...
\begin{figure}[htb]
  ...
  \begin{minipage}[c]{0.48\linewidth}
    \centering
      ...
      \centerline{(b)}\medskip
  \end{minipage}
      \caption{Simulated water color with (a) fixed \gls{cdom} absorption coefficient at $\lambda=440nm$, $a_{CDOM}(440)$ and variable \gls{tss} and chlorophyll-{\it a} concentrations, and (b) fixed .\label{fig:OneCPAfixed}}
\end{figure}
