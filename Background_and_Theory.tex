...
The l2gen tool includes a set of different atmospheric correction methods based on \cite{Gordon:1994}, among others. It also includes the \gls{mumm} algorithm based on \cite{Ruddick:2000bs}. This tool allows to change the bands used for the atmospheric correction. The user can choose from the NIR or SWIR bands. One of the outputs of the l2gen tool is \gls{rrs} at different wavelengths. 
