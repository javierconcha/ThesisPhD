...
\usepackage[twoside]{geometry} % for page margin for odd and even pages to bind them
\geometry{
%  top=1.0in,  
 inner=1.5in,
%  outer=1.5in,
...
% \includeonly{Acronyms,Introduction,Objectives,Background_and_Theory,Methodology} 
...
\bibliography{C:/Users/Aixa/Dropbox/Javier/Latex/ThesisPhD/javier_bib}
