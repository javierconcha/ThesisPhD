...
% Results
The retrieval algorithm was applied over three~\todo{three?} Landsat 8 scenes.
%
...
%
We estimated a normalized root mean squared error (NRMSE) of about $10\%$ for Chlorophyll-{\it a} and total suspended solid (TSS), and about $5\%$ for colored dissolved organic matter (CDOM) when compared with {\it in situ} data. 
% Conclusions
