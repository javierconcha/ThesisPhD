...
This work presents an approach to obtain the coloring producing agents (CPAs) chlorophyll-{\it a}, colored dissolved organic material (CDOM) and suspended material (SM) from water bodies using Landsat 8.
%
...
%
The CPA concentration maps exhibit expected trends of low concentrations in clear water and higher concentrations in turbid water.. 
%
