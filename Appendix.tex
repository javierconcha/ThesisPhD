...
\todo{add filtration procedure}The water samples should be taken using Dark Nalgene bottles (or similar) simultaneously with in-water optical measurements \cite{Mitchell2002}.
...
\todo{complete!}The spectral absorption coefficient are calculated as \cite{Mitchell2002}
\begin{equation}
