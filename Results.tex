...
\begin{table}[htb]
  ...
  \centering
  \includegraphics[width=12cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/ThesisPhD/Images/Collect131415.png}
  \label{tab:collect}
\end{table}
...
The results from the MoB-ELM algorithm were compared with three different products: 1) the \cite{Gordon:1994} approach implemented in the \gls{seadas} tool and 2) the \gls{acolite} tool, and 3) the \cite{Ruddick:2000bs} approach implemented in \gls{seadas}.
% -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
...
\vspace{0.7cm}
  ...
  \end{minipage}
  \vspace{0.7cm}
  \caption{Comparison of $R_{rs}$ spectra from the different atmospheric correction algorithms and {\it in situ} data (dashed line) for the sites on the 09-19-2013 collection for (a) ONTNS: Lake Ontario Near Shore, (b) ONTOS: Lake Ontario Off Shore, (c) ONTEX: Lake Ontario Extra, (d) RVRPLM: River Plume and (e) RVRPIER: River Pier. Note: {\it In situ} data were not available in all stations. \label{fig:13262RrsCompField1}} 
\end{figure}
...
\vspace{0.7cm}
  ...
  \end{minipage}    
    ...
    \vspace{0.7cm}
  \caption{Comparison of $R_{rs}$ spectra from the different atmospheric correction algorithms and {\it in situ} data (dashed line) for the sites on the 09-19-2013 collection for (a) LONGN: Long Pond North, (b) LONGS: Long Pond South, (c) CRANB: Cranberry Pond, (d) BRADIN: Braddock Bay In and (e) BRADONT: Braddock Bay - Lake Ontario side. Note: {\it In situ} data were not available in all stations. \label{fig:13262RrsCompField2}} 
\end{figure}
...
The results of the retrieval for the 09-19-2013 scene is illustrated in the left-hand side of \autoref{fig:CPAsMaps130919} as a concentration map for each CPA. These maps exhibit the expected trend of low concentrations in the lake and higher concentrations in the ponds. 

% ------------
% \subsection{Comparison with {\it in situ} data}
The right-hand side of \autoref{fig:CPAsMaps130919} shows a comparison between measured concentration from the field and retrieved concentration obtained from the retrieval for each CPA for the different sites in the area of study. The dashed line represent the 1:1 line.\todo{separate figures}
