...
% \begin{figure}[htb]
  ...
  \caption{Remote-sensing reflectance ($R_{rs}$) at $443nm$ and $482nm$ from the 09-19-2013 image over the Rochester Embayment (scene LC80160302013262LGN00) processed using the MoB-ELM, SeaDAS-SWIR, Acolite-SWIR and SeaDAS-MUMM.\label{fig:Rrs443_482} } 
\end{figure}
%^^^^^^^^^^^^^^^^^^^  FIGURE ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
\begin{figure}[htb!]
  \begin{minipage}[c]{0.48\linewidth}
